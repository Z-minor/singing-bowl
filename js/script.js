...
function 新個體變速(主體){
    ...
    if(主體.三段式動態==true){
        ...
        if(!主體.斜率1){
            ...
            if(主體.拐點單位=="相對"){
                主體.斜率1=主體.第一拐點[1]/主體.第一拐點[0];
                主體.斜率2=(主體.第二拐點[1]-主體.第一拐點[1])/(主體.第二拐點[0]-主體.第一拐點[0]);
                主體.斜率3=(1-主體.第二拐點[1])/(1-主體.第二拐點[0]);
            }
            else{
                主體.斜率1=主體.第一拐點[1]/主體.第一拐點[0];
                主體.斜率2=(主體.第二拐點[1]-主體.第一拐點[1])/(主體.第二拐點[0]-主體.第一拐點[0]);
                主體.斜率3=(滾輪總深度-主體.第二拐點[1])/(滾輪總深度-主體.第二拐點[0]);
            }
...
{慣性:true,物件id:"位子19",定位方向:"y",y軸錨點:"2000px",y軸偏移:"50vh",移動範圍倍率:0.5,現在位置:0,現在速度:0,每一影格前進等分:4,鬆弛度:50,減速因子:0.9}];
